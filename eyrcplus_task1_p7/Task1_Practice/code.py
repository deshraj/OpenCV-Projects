...
def play(im):
    ...
    for i in range(0,h-1):
        for j in range(0,w):
            if(218<=im.item(i,j,0)<=224 and 208<=im.item(i,j,1)<=212 and 0<=im.item(i,j,2)<=2):
                # print i,j
                w1= j
                h1 = i
                flag=1
    ...
    for i in range(0,h-1):
        flag=0
        for j in range(0,w):
            if( 0<=im.item(i,j,0)<=3 and 217<=im.item(i,j,1)<=224 and 115<=im.item(i,j,2)<=124):
                # print i,j
                w2= j
                h2 = i
                flag=1
